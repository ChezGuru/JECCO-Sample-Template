        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="amortization.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Amortization</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Amortization</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Loan Amortization Data table</h3> 
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><i style="color: blue">300,000.99</i></td>
                    <td><b style="color: red">300,000.99</b></td>
                  </tr>
                   <tr>
                  <td><b style="color: maroon">7545</b></td>
                    <td><i>July 12, 2021</i></td>
